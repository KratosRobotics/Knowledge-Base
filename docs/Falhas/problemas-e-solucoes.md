...
**1. Robô apresenta mensagem "The data of the encoder is less than 10 pac...", "The encoder has no data. The robot can't move on it's own.", indica sempre 0% de bateria**

**Identificação:**

Mensagem de erro

Quando ligado, as luzes da chassis control board devem estar piscantes. No caso relatado, as luzes vermelhas estavam constantes.

**Obs:** com o robô desligado, verifique também se as rodas estão girando de forma suave. Caso contrário, podem estar defeituosas.
